...
const GalleryPage: React.FC = () => (
  <div>
    <h1>Gallery Page</h1>
    <p>Hi! Scrolling instagram I found this nice reel about a guy who did something similar to this on PowerPoint. I liked it soo much and tried to replicate here.</p>
